<!-- Generated by tools/build-cog-skill.mjs from docs/swift/handbook/declaring-state.md. Edit that file and run `mise run skill:build`. -->
...
model is [core design §4](https://skeswa.github.io/cog/swift/design/exploration.md).
