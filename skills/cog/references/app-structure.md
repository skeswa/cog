<!-- Generated by tools/build-cog-skill.mjs from docs/swift/handbook/app-structure.md. Edit that file and run `mise run skill:build`. -->
...
The runtime model is [core design §2](https://skeswa.github.io/cog/swift/design/exploration.md). Assembly and
mechanism ordering are [mechanisms §6.3](https://skeswa.github.io/cog/swift/design/mechanisms.md). The
