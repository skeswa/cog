<!-- Generated by tools/build-cog-skill.mjs from docs/swift/handbook/index.md. Edit that file and run `mise run skill:build`. -->
...
way it does — the [core design](https://skeswa.github.io/cog/swift/design/exploration.md) and
[mechanisms](https://skeswa.github.io/cog/swift/design/mechanisms.md) documents do that, and they also record
...
[`coglint`](https://skeswa.github.io/cog/swift/design/lint.md). The handbook notes where a rule has a linter
behind it.
