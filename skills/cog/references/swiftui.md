<!-- Generated by tools/build-cog-skill.mjs from docs/swift/handbook/swiftui.md. Edit that file and run `mise run skill:build`. -->
...
mechanism ([mechanisms §6.5](https://skeswa.github.io/cog/swift/design/mechanisms.md)).
