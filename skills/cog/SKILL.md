...
The handbook shows the [scope forms step by step](references/side-effects.md).
...
See [the full closing example](references/writing-state.md#discard-release-state-you-no-longer-need).
