...
// SwiftUI adapters stay separate from graph declarations and operations.
// Each binding pairs a tracked getter with a named domain operation, so
// system-driven mutations — tab taps, back gestures, interactive sheet
// dismissal, NavigationLink pushes — enter the graph as ordinary turns.
