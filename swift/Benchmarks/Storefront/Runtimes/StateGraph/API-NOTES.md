...
| Fact                   | Value                                                                                |
| ---------------------- | ------------------------------------------------------------------------------------ |
| Checkout               | `swift/Benchmarks/Storefront/Runtimes/StateGraph/.build/checkouts/swift-state-graph` |
| `git describe --tags`  | `0.28.0`                                                                             |
| HEAD                   | `e602fcdb19342a38c135543e7228b3fd60753dc7`                                           |
| Resolved by            | this package's `Package.resolved`, lines 5–11                                        |
...
```
git -C swift/Benchmarks/Storefront/Runtimes/StateGraph/.build/checkouts/swift-state-graph describe --tags
```

## The probe

The measurements quoted throughout live in `Probes/APIBehavior/`, a SwiftPM
package named `sgprobe` that depends on swift-state-graph `exact: "0.28.0"`.
Run it with:
...
is `swift/Benchmarks/Runner/Benchmarks/RuntimeComparison/StateGraphRuntimeComparisonGraph.swift`
