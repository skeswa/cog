...
// `StorefrontAsync.swift` in `swift/Benchmarks/Macro/Storefront/Workload/Sources/CogStorefront/`. Those
...
//    `swift/Benchmarks/Benchmarks/CogGraph/`. The assumption is checked at
