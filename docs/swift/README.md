...
edge behaviors: what a stream's status does when its sequence throws, whether
equal stream elements commit distinct turns, and debounce/throttle timing
modifiers (deferred backlog).
